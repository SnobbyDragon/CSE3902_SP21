        ...
        private static readonly Dictionary<int, Dictionary<Direction, int>> adjacentRooms = new Dictionary<int, Dictionary<Direction, int>>
            {
                ...
                { 3, new Dictionary<Direction, int> { { Direction.West, 2 }, { Direction.East, 4 }, { Direction.North, 1 } } },
                { 4, new Dictionary<Direction, int> { { Direction.West, 3}, { Direction.South, 9 }, { Direction.East, 5 } } },
                { 5, new Dictionary<Direction, int> { { Direction.North, 8 }, { Direction.West, 4 }, { Direction.East, 6 } } },
                { 6, new Dictionary<Direction, int> { { Direction.West, 5 }, { Direction.North, 7 } } },
                { 7, new Dictionary<Direction, int> { { Direction.West, 8 }, { Direction.South, 6 } } },
                ...
                { 10, new Dictionary<Direction, int> { { Direction.North, 9 }, { Direction.East, 11 } } },
                { 11, new Dictionary<Direction, int> { { Direction.West, 10 }, { Direction.East, 12 } } },
                { 12, new Dictionary<Direction, int> { { Direction.West, 11 }, { Direction.East, 13 } } },
                { 13, new Dictionary<Direction, int> { { Direction.West, 12 } } }
            };
