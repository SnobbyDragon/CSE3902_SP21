...
namespace sprint0
{
    ...
    public class HUDFactory
    {
        ...
        public IHUDInventory MakeHUDItem(HUDEnum spriteType, Vector2 location)
        {
            ...
            {
                HUDEnum.Rupee => new RupeeHUD(texture, new Vector2(location.X + 97 * Game1.Scale, location.Y + 16 * Game1.Scale)),
                HUDEnum.Key => new KeyHUD(texture, new Vector2(location.X + 97 * Game1.Scale, location.Y + 32 * Game1.Scale)),
                HUDEnum.Bomb => new BombHUD(texture, new Vector2(location.X + 97 * Game1.Scale, location.Y + 40 * Game1.Scale)),
