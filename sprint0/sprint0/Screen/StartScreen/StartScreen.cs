...
namespace sprint0
{
    public class StartScreen
    {
        ...
        private readonly string messageStart = "Press SPACE to start playing!";
        ...
        private readonly int yCoord0 = 100;
        private readonly int xCoord1 = 50;

        private readonly int yCoord12 = 200;
        ...
        public StartScreen(Game1 game)
        {
            ...
            textList = new List<Text> {
                ...
                new Text(game, messageStart, new Vector2(xCoord1, yCoord12 + xCoord1), textColor),
